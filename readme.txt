...
Tags: registration, username, signup, users, restrictions, coffee2code
...
NOTE: This plugin does not put any restrictions on usernames that the admin chooses for users when creating user accounts from within the
